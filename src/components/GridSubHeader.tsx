...
export const GridSubHeader: React.FC<GridSubHeaderProps> = ({
  ...
  return (
    <div className="bg-[#0f172a] rounded-xl border border-slate-800 px-4 py-2.5 flex items-center justify-between gap-3 text-xs shadow-sm">
      {/* Left: Counter Badge (Visible on all screens) */}
      ...
      {/* Center & Right: Desktop Toolbar (hidden on mobile, visible lg and up) */}
      <div className="hidden lg:flex items-center space-x-4">
        ...
        {/* Quick Selection & Rotation Actions */}
